...
function Clock() {
    ...
    const stringDate = `${("0" + date.getDate()).slice(-2)}.${date.getMonth() + 1}.${date.getFullYear()}` || <br/> ||
    ...
    const stringDay = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'] || <br/> // пишут студенты
    const stringMonth =
        ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'] || <br/> // пишут студенты
